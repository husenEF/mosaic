  ...
  return (
    <div className="p-8 w-full max-w-full mx-auto">
      <div className="flex flex-col xs:flex-row xs:justify-between mb-8">
        <h2 className="text-2xl font-bold text-white font-oxigens">Staff</h2>
        <Button
          icon={GoPlus}
          title="New Staff"
        ...
        <Card className="px-0 col-span-12 col-start-1 md:col-span-8 md:col-start-3 xl:col-span-10 xl:col-start-2">
          <CardBody>
            ...
            <div className="overflow-x-auto">
              <table className="w-full divide-y bg-gray-50 overflow-hidden rounded-10 text-left text-sm table table-auto">
